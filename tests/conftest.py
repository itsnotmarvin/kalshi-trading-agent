...
def _redirect_weather_forecast_log(tmp_path, monkeypatch):
    """
    WeatherEngine logs every analyzed market to data/runtime/weather_forecast_log.jsonl
...
def _isolate_daily_breaker_state():
    ...
    (data/runtime/daily_stats_state.json). Tests construct fresh RiskManager
    ...
    state_file = RUNTIME_DATA_DIR / "daily_stats_state.json"
